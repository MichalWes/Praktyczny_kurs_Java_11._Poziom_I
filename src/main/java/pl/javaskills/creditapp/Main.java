...
public class Main {
    ...
    public static void main(String[] args) {
        LoanApplication loanApplication = new LoanApplication(new Person(new PersonalData("Michal", "Wes", "Wis" ),new ContactData()), new PurposeOfLoan());
        ...
        loanApplication.getPerson().getPersonalData().setTotalMonthlyIncomePLN(10000.0);
