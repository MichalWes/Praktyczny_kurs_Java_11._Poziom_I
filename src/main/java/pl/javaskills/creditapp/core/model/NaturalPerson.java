...
public class NaturalPerson extends Person{
    ...
    private NaturalPerson(String pesel, PersonalData personalData, FinanceData financeData, ContactData contactData) {
    ...
    public static class Builder{
        ...
        public NaturalPerson build(){
            return new NaturalPerson(pesel, personalData, financeData, contactData);
        }
    }
}